...
|------|------|------|---------|
| 2026-06-03 | generic | [20260603-unlistenfn-import-fix-tauri-v2-type-only-export_log.md](docs/devlog/20260603-unlistenfn-import-fix-tauri-v2-type-only-export_log.md) | **Hotfix:** `UnlistenFn` is a type-only export in Tauri v2 — split into `import type` in log-store + ActivityFeedPanel. Blank window fix. |
| 2026-06-03 | slice | [20260603-slice-12-captains-log-and-activity-feed-issue14_log.md](docs/devlog/20260603-slice-12-captains-log-and-activity-feed-issue14_log.md) | **Issue #14 Complete (14/14 AC):** Captain's Log + Activity Feed — Rust log module (16 tests) + Tauri commands + TS types/store (19 tests) + 7 UI components + CSS + session lifecycle auto-emission. **187 Rust · 599+ frontend** |
